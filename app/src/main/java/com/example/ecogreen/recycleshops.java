...
public class recycleshops extends RecyclerView.Adapter<recycleshops.MyViewHolder> {

    private final Context mContext;
    private final List<Anime> mData;
    RequestOptions option;

    public recycleshops(Context mContext, List<Anime> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.anime_row_shop,parent,false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView shop,description,phone,location,view;
