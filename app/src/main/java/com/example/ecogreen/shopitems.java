...
public class shopitems extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "https://ecogreenapp.herokuapp.com/apis/get_shopitems_api.php?5$fgk=hh&username="+ username;
        ...
        try {
            ...
            Response.Listener<JSONArray> successListener = response -> {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        Toast.makeText(shopitems.this,"No items found",Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
            ...
            Response.ErrorListener errorListener = error -> {
                if (error instanceof NoConnectionError) {
                    ...
                    Toast.makeText(shopitems.this, "No internet access", Toast.LENGTH_LONG).show();
                } else {
                    setContentView(R.layout.error);
                    Toast.makeText(shopitems.this, "No response,Make sure you have a strong internet connection", Toast.LENGTH_LONG).show();
                }
                progressDialog.dismiss();
            };
            JsonArrayRequest request = new JsonArrayRequest(JSON_URL, successListener, errorListener);
            RequestQueue requestQueue = Volley.newRequestQueue(shopitems.this);
            requestQueue.add(request);


        } catch (Exception e) {
            Toast.makeText(shopitems.this, "json exception", Toast.LENGTH_LONG).show();
        }
